...
def generate_launch_description():
    ...
    map_dir = os.path.join(pkg_warehouse_bot, 'config', 'warehouse_map.yaml')
    rviz_config_file = os.path.join(pkg_warehouse_bot, 'config', 'multi_nav2_default_view.rviz')
    ...
    for robot in robots:
        ...
        bringup_cmd = IncludeLaunchDescription(
            ...
            launch_arguments={
                'namespace': namespace,
                'map': os.path.join(pkg_warehouse_bot, 'config', 'warehouse_map.yaml'),
                'use_namespace': 'True',
        ...
        rviz = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(pkg_warehouse_bot,'launch', "rviz_launch.py")),
                launch_arguments={
                    "namespace": namespace,
                    "use_namespace": 'true',
                    "rviz_config": os.path.join(pkg_warehouse_bot, 'config', 'multi_nav2_default_view.rviz'),
                }.items()
        )
