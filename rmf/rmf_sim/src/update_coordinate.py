...
def main():
    input_file_path = os.path.join(get_package_share_directory('rmf_sim'), 'map', 'ware.building.yaml')
    output_file_path = os.path.join(get_package_share_directory('rmf_sim'), 'config', 'robots.yaml')
